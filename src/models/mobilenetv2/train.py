"""
Training script for MobileNetV2 on crop disease detection.

Single-phase training — full model trained end-to-end with pretrained weights.

Notebook settings (MobileNet.ipynb):
    Adam lr=0.0001, dropout=0.1, StepLR(step_size=7, gamma=0.1), 18 epochs
...
Outputs saved to checkpoints/mobilenetv2/
