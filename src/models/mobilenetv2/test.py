"""
Evaluation script for the trained MobileNetV2 model.
...
-------------------------------------------
    python -m src.models.mobilenetv2.test
    python -m src.models.mobilenetv2.test --checkpoint path/to/best_model.pth
"""
import os
import sys
import argparse
...
from src.models.mobilenetv2.model import build_mobilenetv2
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate MobileNetV2 on the test set.')
