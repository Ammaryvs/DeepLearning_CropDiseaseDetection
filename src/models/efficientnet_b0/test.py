"""
Evaluation script for the trained EfficientNet-B0 model.
...
Notebook results (efficientnet.ipynb):
    Accuracy: 99.78% | Precision: 99.78% | Recall: 99.78% | F1: 99.78%

Usage (run from the project root directory)
-------------------------------------------
    python -m src.models.efficientnet_b0.test
    python -m src.models.efficientnet_b0.test --checkpoint path/to/best_model.pth
"""
import os
import sys
import argparse
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate EfficientNet-B0 on the test set.')
